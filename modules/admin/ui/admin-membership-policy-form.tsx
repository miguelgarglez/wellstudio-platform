        ...
        <div className="grid gap-2">
          {policyOptions.map((option) => (
            <label
              key={option.value}
              className={cn(
                'group relative block cursor-pointer rounded-[1.05rem] border px-4 py-3 transition-[border-color,background-color,box-shadow] duration-200 focus-within:ring-2 focus-within:ring-[var(--ring)]',
            ...
            >
              ...
              <div className="flex items-start gap-3">
                ...
                <span className="min-w-0 space-y-1">
                  ...
                  <span className="block text-sm leading-6 text-[color:color-mix(in_srgb,var(--foreground)_72%,white)]">
                    {option.description}
                  </span>
                </span>
              </div>
