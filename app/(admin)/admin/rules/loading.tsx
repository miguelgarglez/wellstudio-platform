...
export default function AdminRulesLoading() {
  return (
    <AdminSectionShell eyebrow="Admin · Reglas" title="Reglas de reserva" description="Define qué puede reservar cada membership plan sin tocar excepciones individuales ni mezclar esta superficie con el portal del socio.">
